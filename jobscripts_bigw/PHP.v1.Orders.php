...
include_once(dirname(__FILE__).'\\pmo.php');
...
$tables[$i]['check_del_sql2'] = 'SELECT count(ID) FROM [710].[dbo].[ItemAccounts] (nolock) WHERE ID = :ID'; 
$tables[$i]['check_del_sql3'] = 'DELETE FROM `sales_itemaccounts` WHERE ID = :ID AND website_id = '.$website_id; 

$tables[$i]['check_ins_sql1'] = 'SELECT ID as \':ID\' FROM [710].[dbo].[ItemAccounts] (nolock)'; 
...
$tables[$i]['check_del_sql2'] = 'SELECT count(ID) FROM [710].[dbo].[orsrg] (nolock) WHERE ID = :ID'; 
$tables[$i]['check_del_sql3'] = 'DELETE FROM `sales_orsrg` WHERE ID = :ID AND website_id = '.$website_id;  

$tables[$i]['check_ins_sql1'] = 'SELECT ID as \':ID\' FROM [710].[dbo].[orsrg] (nolock)'; 
...
$tables[$i]['check_del_sql2'] = 'SELECT count(ID) FROM [710].[dbo].[orkrg] WHERE ID = :ID'; 
$tables[$i]['check_del_sql3'] = 'DELETE FROM `sales_orkrg` WHERE ID = :ID AND website_id = '.$website_id; 
 
$tables[$i]['check_ins_sql1'] = 'SELECT ID as \':ID\' FROM [710].[dbo].[orkrg]'; 
...
foreach($tables as $t){
	...
	$Mag->Mag_Timestamp(dirname(__FILE__)."\\PHP.v1.Orders.$table.txt");
		
	$rs = $pmo->db[0]->prepare("SELECT " . implode(", ", $columns) . " FROM [710].[dbo].[$source_table] (nolock) WHERE CONVERT(INT, $timestamp_column) > ".$Mag->timestamp." ORDER BY $timestamp_column");

...
//SOAP
$proxy = new SoapClient('http://rentalapp.11aa.nl/api/soap/?wsdl');
$sessionId = $proxy->login('exact', 'tyudgf');

//MYSQL MAGE
define('MAGEHOST','199.193.118.134');
define('MAGEDATABASE','shop_rentalv2');
define('MAGEUSERNAME','shop_h2c');
define('MAGEPASSWORD','B3QoFO34lEn2s23APi1us3t5JI1A23');

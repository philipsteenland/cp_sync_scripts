...
$Mag->Mag_Timestamp("C:\\xampp\\htdocs\\shop\\jobscripts\\SOAP.v1.AddSuppliers.txt");
...
WHERE   ( c.crdnr IS NOT NULL
        ...
        AND CASE WHEN c.crdnr IS NULL
                      AND TextField28 IS NOT NULL THEN TextField28 - 600000
                 ELSE c.crdnr
            END BETWEEN 100000
                AND     200000
...
if($rs && $rs->_numOfRows > 0){			
	...
	WHERE  CASE WHEN c.crdnr is null and TextField28 is not null THEN TextField28 else c.crdnr+600000 END = '".$rs->fields['debnr']."'

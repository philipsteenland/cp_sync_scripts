...
$Mag->Mag_Timestamp(dirname(__FILE__)."\\SOAP.v1.AddCustomers.txt");
...
$sql = "SELECT  c.debnr ,
        ...
        CASE WHEN c2.cnt_email IS NULL
             ...
             THEN CONVERT(VARCHAR(40), NEWID()) + '@h2p.nl'
             ELSE c2.cnt_email
        END AS cnt_email ,
        c.VatNumber ,
        c.PriceList ,
        CASE ISNULL(c.PriceList, 'SALESPRICE')
		  WHEN 'SALESPRICE' THEN 1    
          WHEN 'A LEVEL' THEN 29
          WHEN 'B LEVEL' THEN 30
		  WHEN 'C LEVEL' THEN 31		  
          ELSE 1

...
$result = $proxy->call($sessionId, 'catalog_category.tree',array(3115,31));


print_r($result);

$assignedProducts = $proxy->call($sessionId, 'catalog_category.assignedProducts', array(3115,1,31));

...
//SOAP
$proxy = new SoapClient('http://acceptatie.imperialriding.nl/api/soap/?wsdl');
...
//MYSQL MAGE
define('MAGEHOST','vps3.hypo-groep.nl');
define('MAGEDATABASE','admin_irmagento');
define('MAGEUSERNAME','admin_irmagento');
define('MAGEPASSWORD','Ua6mqR1b');
...
class Mag {
	...
	function Mag(){
		...
		//FTP SETTINGS
		$this->ftp_user   = 'admin';	
		$this->ftp_password   = 'tZseydyl';	
		$this->ftp_host   = 'vps3.hypo-groep.nl';	
		$this->tempfolder   = 'C:/';		
		
		$this->productmediafolder   = '/domains/imperialriding.nl/public_html/shop/media/catalog/product';	
		$this->categorymediafolder = '/domains/imperialriding.nl/public_html/shop/media/catalog/category';
		...
		//Import orders
		$this->xmlpath = 'C:\\xampp\\htdocs\\shop\\jobscripts_ir\\XML\\';	

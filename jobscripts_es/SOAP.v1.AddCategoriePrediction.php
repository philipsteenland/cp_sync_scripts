...
$Mag=new Mag;
$Mag->Mag_Timestamp("C:\\xampp\\htdocs\\shop\\jobscripts\\SOAP.v1.AddCategoriePrediction.txt");
...
$children = $Mag_Mssql->Mssql->GetAssoc("SELECT ex_artcode, oms20_4 FROM artoms WHERE oms20_4 IS NOT null");

...
$proxy = new SoapClient('http://shop.euro-star.de/api/soap/?wsdl');

$representative_id = '690001';
$representative_password = 'eurostar1';
$sessionId = $proxy->login($representative_id, $representative_password); 


//$assignedProducts = $proxy->call($sessionId, 'catalog_category.info', array(3115));
//Will output assigned products.



$assignedProducts = $proxy->call($sessionId, 'category.assignedProducts', array(3115,0));

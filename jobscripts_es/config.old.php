...
//SOAP
$proxy = new SoapClient('http://shop.eurostar.hypo-groep.nl/api/soap/?wsdl');
$sessionId = $proxy->login('exact', 'tyudgf');

//MYSQL MAGE
//define('MAGEHOST','82.204.8.54');
//define('MAGEDATABASE','mag2');
//define('MAGEUSERNAME','phil');
//define('MAGEPASSWORD','euioax12');

//MYSQL MAGE
define('MAGEHOST','vps4.hypo-groep.nl');
define('MAGEDATABASE','admin_euromagento');
define('MAGEUSERNAME','admin_magento');
define('MAGEPASSWORD','MHsqbEH8');
...
define("MAIL_USER",'hypoconcern.nl\support'); 
define("MAIL_PASS",'pw4support');

//Exact SQLSERVER
define("EXACT_SERVER", '192.168.0.22');
define("EXACT_DB",'ES_600');
...
class Mag {
	...
	function Mag(){
		...
		//MAGENTO SETTINGS
		$this->stores = array(0,1);
		$this->rootcategory = 3;
		$this->rootipad = 2;
				
		//FTP SETTINGS
		$this->ftp_user   = 'admin';	
		$this->ftp_password   = 'MHsqbEH8';	
		$this->ftp_host   = 'vps4.hypo-groep.nl';	
		$this->tempfolder   = 'C:/';		
		
		$this->productmediafolder   = '/domains/hypo-groep.nl/public_html/shop.eurostar/media/catalog/product';	
		$this->categorymediafolder = '/domains/hypo-groep.nl/public_html/shop.eurostar/media/catalog/category';
		...
		//Import orders
		$this->xmlpath = 'C:\\xampp\\htdocs\\shop\\jobscripts_es\\XML\\';	
		$this->default_server = 'sql-server2';
		$this->default_db = 'ES_600';
		
		//COMPANY SETTINGS
		
		$this->customer_range_start = 1;
		$this->customer_range_end   = 200000;	
		
		$this->company_warehouse = '600';
		$this->company_start_order = 0;
		$this->company_shopmanager = '50162';
		$this->company_costcenter = 'ES';
